         ...
         >
          {
           ...
           <div className="prev-banner" onClick={()=> previousBanner()}>
           </div>
           <div className="next-banner" onClick={()=>nextBanner()}>
           </div>
          <div className="movie-details">
            <h1>{Popular[backgroundImage]?.title}</h1>
            <p>{Popular[backgroundImage]?.overview}</p>
            <div>
              <button onClick={()=> setSelectedMovie(`${Popular[backgroundImage].id}`)}>Know More</button>
            </div>
          </div>
